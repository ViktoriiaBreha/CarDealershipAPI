...
public class VehicleController {
    ...
    @RequestMapping(path = "/car_dealership", method = RequestMethod.GET)
    public List<Vehicle> getAllVehiclesByPriceRange(@RequestParam double min, double max) {
        return vehicleService.getAllVehiclesByPriceRange(min, max);
    }

    @RequestMapping(path = "/car_dealership", method = RequestMethod.GET)
    public List<Vehicle> getAllVehiclesByMakeModel(@RequestParam String make, String model) {
        return vehicleService.getAllVehiclesByMakeModel(make, model);
    }

    @RequestMapping (path = "/car_dealership", method = RequestMethod.GET)
    public List<Vehicle> getAllVehiclesByYearRange(@RequestParam int min, int max ) {
    ...
    @RequestMapping (path = "/car_dealership", method = RequestMethod.GET)
    public List<Vehicle> getAllVehiclesByMileageRange(@RequestParam int min, int max ) {
